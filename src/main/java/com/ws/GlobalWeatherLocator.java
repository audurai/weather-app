...
public class GlobalWeatherLocator extends org.apache.axis.client.Service implements GlobalWeather {
	...
	public GlobalWeatherLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public GlobalWeatherSoap getGlobalWeatherSoap() throws javax.xml.rpc.ServiceException {
	...
	public GlobalWeatherSoap getGlobalWeatherSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			GlobalWeatherSoapStub _stub = new GlobalWeatherSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (GlobalWeatherSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				GlobalWeatherSoapStub _stub = new GlobalWeatherSoapStub(new java.net.URL(GlobalWeatherSoap_address),
						this);
				_stub.setPortName(getGlobalWeatherSoapWSDDServiceName());
				return _stub;
			}

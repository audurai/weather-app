...
public class GlobalWeatherSoapProxy implements GlobalWeatherSoap {
  private String _endpoint = null;
  private GlobalWeatherSoap globalWeatherSoap = null;
  ...
  private void _initGlobalWeatherSoapProxy() {
    try {
      globalWeatherSoap = (new GlobalWeatherLocator()).getGlobalWeatherSoap();
